...
describe("generator.js tests", () => {
  describe("convertValidatorReport tests", () => {
    test("When passed a version 0 report with no errors or warnings then returns an empty array", () => {
      const reportInput = {
        version: "0.80.0",
      };
    ...
    test("When passed a version 1 report with no errors or warnings then returns an empty array", () => {
      const reportInput = {
        error: {
          results: [],
        },
    ...
    test("When passed a V0 report with empty errors then returns an empty array", () => {
      const reportInput = {
        version: "0.80.0",
        errors: [],
      };
    ...
    test("When passed a V0 report with empty warnings then returns an empty array", () => {
      const reportInput = {
        version: "0.80.0",
        warnings: [],
      };
    ...
    test("When passed a V0 report with errors then returns an array containing converted errors", () => {
      const reportInput = {
        version: "0.80.0",
        errors: [
          {
    ...
    test("When passed a V1 report with errors then returns an array containing converted errors", () => {
      const reportInput = {
        error: {
          results: [
            {
    ...
    test("When passed a V0 report with warnings then returns an array with converted warnings", () => {
      const reportInput = {
        version: "0.80.0",
        warnings: [
          {
    ...
    test("When passed a V1 report with warnings then returns an array with converted warnings", () => {
      const reportInput = {
        warning: {
          results: [
            {
